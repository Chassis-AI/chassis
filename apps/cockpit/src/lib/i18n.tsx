...
const fr: Dict = {
  ...
  "deposit.open": "＋ Déposer un dossier",
  "deposit.heading": "Déposer un dossier",
  "deposit.kindDsn": "DSN / Paie",
  "deposit.kindIj": "Arrêt maladie (IJ)",
  "deposit.client": "Client (ex. Atelier Corso)",
  "deposit.salary": "Salaire de base (€)",
  "deposit.bonus": "Primes (€)",
  "deposit.maintien": "Fin du maintien",
  "deposit.subro": "Fin de subrogation",
  "deposit.submit": "Soumettre au harness",
  "deposit.submitting": "Jugement en cours…",
  "deposit.liveQueued": "Déposé. Le daemon le revendique et le juge — le verdict apparaît dans la file d'ici quelques secondes.",
...
const en: Dict = {
  ...
  "deposit.open": "＋ Submit a case",
  "deposit.heading": "Submit a case",
  "deposit.kindDsn": "Payroll filing",
  "deposit.kindIj": "Sick leave (benefits)",
  "deposit.client": "Client (e.g. Corso Workshop)",
  "deposit.salary": "Base salary (€)",
  "deposit.bonus": "Bonuses (€)",
  "deposit.maintien": "Salary continuation ends",
  "deposit.subro": "Subrogation ends",
  "deposit.submit": "Submit to the harness",
  "deposit.submitting": "Judging…",
  "deposit.liveQueued": "Submitted. The daemon claims and judges it — the verdict appears in the queue within seconds.",
...
const es: Dict = {
  ...
  "deposit.open": "＋ Presentar expediente",
  "deposit.heading": "Presentar un expediente",
  "deposit.kindDsn": "Declaración de nómina",
  "deposit.kindIj": "Baja médica (subsidios)",
  "deposit.client": "Cliente (ej. Taller Corso)",
  "deposit.salary": "Salario base (€)",
  "deposit.bonus": "Primas (€)",
  "deposit.maintien": "Fin del mantenimiento",
  "deposit.subro": "Fin de la subrogación",
  "deposit.submit": "Enviar al harness",
  "deposit.submitting": "Juzgando…",
  "deposit.liveQueued": "Presentado. El daemon lo reclama y lo juzga — el veredicto aparece en la cola en unos segundos.",
...
const zh: Dict = {
  ...
  "deposit.open": "＋ 提交案卷",
  "deposit.heading": "提交案卷",
  "deposit.kindDsn": "薪酬申报",
  "deposit.kindIj": "病假（津贴）",
  "deposit.client": "客户（例：Corso 工作室）",
  "deposit.salary": "基本工资（€）",
  "deposit.bonus": "奖金（€）",
  "deposit.maintien": "工资保障截止日",
  "deposit.subro": "代位求偿截止日",
  "deposit.submit": "提交至校验闸门",
  "deposit.submitting": "裁定中…",
  "deposit.liveQueued": "已提交。daemon 正在认领并裁定 — 裁定结果将在几秒内出现在队列中。",
  "deposit.done": "查看队列",
